...
# Configs
PRODUCT_COPY_FILES += \
    device/sony/kumquat/prebuilt/system/etc/media_codecs.xml:system/etc/media_codecs.xml \
    device/sony/kumquat/prebuilt/system/lib/egl//egl.cfg:system/lib/egl/egl.cfg \
    device/sony/kumquat/prebuilt/system/etc/asound.conf:system/etc/asound.conf \
    device/sony/kumquat/prebuilt/system/etc/dbus.conf:system/etc/dbus.conf \
    device/sony/kumquat/prebuilt/system/etc/sysmon.cfg:system/etc/sysmon.cfg \
    device/sony/kumquat/prebuilt/system/etc/wifi/hostapd.conf:system/etc/wifi/hostapd.conf \
    device/sony/kumquat/prebuilt/system/etc/init.d/01stesetup:system/etc/init.d/01stesetup \
    device/sony/kumquat/prebuilt/system/etc/init.d/10dhcpcd:system/etc/init.d/10dhcpcd \
    device/sony/kumquat/prebuilt/system/etc/init.d/10hostapd:system/etc/init.d/10hostapd \
    device/sony/kumquat/prebuilt/system/etc/init.d/50selinuxrelabel:system/etc/init.d/50selinuxrelabel \
    device/sony/kumquat/prebuilt/system/etc/wifi/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf
...
# Custom init / uevent
PRODUCT_COPY_FILES += \
    device/sony/kumquat/prebuilt/root/init.rc:root/init.rc \
    device/sony/kumquat/prebuilt/root/fstab.st-ericsson:root/fstab.st-ericsson \
    device/sony/kumquat/prebuilt/root/init.st-ericsson.rc:root/init.st-ericsson.rc \
    device/sony/kumquat/prebuilt/root/ueventd.st-ericsson.rc:root/ueventd.st-ericsson.rc
...
# HW Configs
PRODUCT_COPY_FILES += \
    device/sony/kumquat/prebuilt/system/etc/omxloaders:system/etc/omxloaders \
    device/sony/kumquat/prebuilt/system/etc/ril_config:system/etc/ril_config \
    device/sony/kumquat/prebuilt/system/bin/install_wlan:system/bin/install_wlan \
    device/sony/kumquat/prebuilt/system/etc/ste_modem.sh:system/etc/ste_modem.sh

# GPS
PRODUCT_COPY_FILES += \
    device/sony/kumquat/prebuilt/system/etc/gps.conf:system/etc/gps.conf\
    device/sony/kumquat/prebuilt/system/etc/suplcert/cacert.txt:system/etc/suplcert/cacert.txt
